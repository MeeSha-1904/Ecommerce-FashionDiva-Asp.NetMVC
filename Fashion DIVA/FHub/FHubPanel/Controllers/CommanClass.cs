    ...
    public static class CommanClass
    {
        ...
        public static string GenerateMailBody(string _Title, string _MainDesc, string _MainContent, string _Description)
        {
            try
            {
                ...
                _Body += " <a href=\"http://admin.fashiondiva.biz/\" style=\"color: #ffffff;\"><font color=\"#ffffff\">FashionDIVA</font></a><br/>";
                //_Body += " <a href=\"http://jayamsoft.net/\" style=\"color: #ffffff;\"><font color=\"#ffffff\">JayamSoft</font></a> Since 2015";
                _Body += " </td>";
                _Body += " </tr>";
                _Body += " </table>";
                _Body += " </td>";
